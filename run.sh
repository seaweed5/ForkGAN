...
python main.py --phase train --dataset_dir drone --gpu 0 --n_d 2 --n_scale 2 --checkpoint_dir ./check/drone --sample_dir ./check/drone/sample --L1_lambda 10 --use_upsampling 1 --input_nc 3 --output_nc 3 #--epoch 3 --epoch_step 1 #--load_size 156 --fine_size 128 --continue_train 0 
